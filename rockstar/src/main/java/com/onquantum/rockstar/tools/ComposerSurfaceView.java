 ...
 */
public class ComposerSurfaceView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public ComposerSurfaceView(Context context, AttributeSet attributeSet) {
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, final int width, final int height) {
        ...
        for (int n = 0; n<6; n++) {
            ...
            lineHeight.setVisibleArea(new RectF(0.0f, height, width, 0.0f));
            lineY += dividerHeight;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for(int bar = 0; bar< 24; bar++) {
                    ...
                    barBitmap.setVisibleArea(new RectF(0.0f, h, w, 0.0f));
                ...
                for (int lad = 0; lad<24; lad++) {
                    ...
                    ladBitmap.setVisibleArea(new RectF(0.0f, h, w, 0.0f));
                    tmp.add(ladBitmap);
                    s += barWidth;
                }
                SBarCursor cursor = new SBarCursor(RATIO * 2,dividerHeight * 7, RATIO * 2 + barWidth,dividerHeight * 8);
                cursor.setVisibleArea(new RectF(0.0f, h, w, 0.0f));
                tmp.add(cursor);
                barCursor = cursor;
